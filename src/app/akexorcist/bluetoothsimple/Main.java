...
public class Main extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(Main.this, "Bluetooth is not available", Toast.LENGTH_SHORT).show();
            finish();
        }
	}
    ...
    public void setupChat() {
        ...
        listDataIncoming.setAdapter(new ArrayAdapter(Main.this, android.R.layout.simple_list_item_1, arr_list));
        ...
        btnPair.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
            	if(!isConnected) {
	            	Intent serverIntent = new Intent(Main.this, SelectDevice.class);
	                startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE_SECURE);
            	} else {
            		mChatService.stop();
            		mChatService = new BluetoothService(Main.this, mHandler);
            		isConnected = false;
            	}
            }
        });
    ...
    public void sendMessage(String message) {
        if (mChatService.getState() != BluetoothService.STATE_CONNECTED) {
            Toast.makeText(Main.this, "Device is not connected", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQUEST_ENABLE_BT:
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(Main.this, "Bluetooth was not enabled. Leaving Bluetooth Chat", Toast.LENGTH_SHORT).show();
                finish();
            }
        }
    }
